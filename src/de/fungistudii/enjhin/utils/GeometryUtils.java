...
import static de.fungistudii.enjhin.utils.MathUtils.det;
import static de.fungistudii.enjhin.utils.MathUtils.max;
import static de.fungistudii.enjhin.utils.MathUtils.min;
import static de.fungistudii.enjhin.utils.MathUtils.mirror;
...
public abstract class GeometryUtils {
	...
	public static boolean between(Vector2 point, Vector2 a, Vector2 b, boolean inclusive) {
		return det(a.x, a.y, point.x, point.y, b.x, b.y) == 0 && MathUtils.between(point.x, a.x, b.x, inclusive) && MathUtils.between(point.y, a.y, b.y, inclusive);
	}
