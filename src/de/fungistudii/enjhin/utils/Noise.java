...
import static de.fungistudii.enjhin.utils.ArrayUtils.wrapIndex;
...
public abstract class Noise {
    ...
    /**
     * @see #midpointDisplacement(int, float, float, boolean, Accessor, int,
     * int)
     */
     ...
     * @param range the range used for random values
     * @param smoothness the smoothness of the transitions
     * @param initializeRandomly if init should be ignored to use random values
     * instead
     * @param init an Accessor that takes the coordinate to be initialized (in a
     * Pair) and returns the value to use for initialization
    ...
    /**
     * @see #diamondSquare(int, float, float, boolean, boolean, boolean,
     * Accessor, int, int)
     */
    ...
    /**
     * @see #diamondSquare(int, float, float, boolean, boolean, boolean, float,
     * int, int)
     */
    ...
    /**
     * a copy of {@link com.badlogic.gdx.math.MathUtils#random(float, float)}
     * using the {@link #random Random object} of {@link Noise}
     *
